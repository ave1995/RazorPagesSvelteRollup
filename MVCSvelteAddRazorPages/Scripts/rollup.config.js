    ...
    plugins: [
      alias({
        entries: [
          {
            find: "$lib",
            replacement: path.resolve(__dirname, config.libRelativePath),
          },
          ...
          {
            find: "$home",
            replacement: path.resolve(__dirname, config.homeRelativePath),
          },

          {
            find: "$shared",
            replacement: path.resolve(__dirname, config.sharedRelativePath),
          },
